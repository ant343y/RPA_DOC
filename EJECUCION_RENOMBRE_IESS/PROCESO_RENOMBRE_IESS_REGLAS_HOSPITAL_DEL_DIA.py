...
ruta_renombre_hospital_del_dia = '/run/user/1000/gvfs/smb-share:server=192.168.10.249,share=carterauio/EJECUCION_RENOMBRE_IESS/RENOMBRE_REGLAS_HOSPITAL_DEL_DIA'
ruta_revision_hospital_del_dia = '/run/user/1000/gvfs/smb-share:server=192.168.10.249,share=carterauio/EJECUCION_RENOMBRE_IESS/REVISION_REGLAS_HOSPITAL_DEL_DIA'
...
# Procesar archivos en la carpeta base hospital_del_dia
...
print("Proceso completado hospital del dia reglas.")